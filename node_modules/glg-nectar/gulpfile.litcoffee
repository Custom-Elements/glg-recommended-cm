Build glg-nectar from source into
build/glg-nectar.html, all streamlined and ready to be included.
...
Vulcanize for the speed.
    ...
    gulp.task 'vulcanize', ['elements'], ->
      built = 'build/glg-nectar.html'
      gulp.src ''
        .pipe shell([
          "vulcanize --inline --strip -o glg-nectar.html #{__dirname}/build/*.html"
          ])
